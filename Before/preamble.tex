...
%\title{Integration of TCAS in Autonomous Aircrafts}
\title{Online Planner for Multi-Rotors based on Modified RRT and Trajectory-Optimization}
\date{January 2020}
\author{Ant\'{o}nio Ramalho, Rodrigo Ventura, Afzal Suleman \\ antonio.ramalho@tecnico.ulisboa.pt \\ \\ Instituto Superior T\'{e}cnico, Lisboa, Portugal}
